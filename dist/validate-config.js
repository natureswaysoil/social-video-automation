...
async function main() {
    ...
    if (platforms.includes('facebook'))
        requiredSecrets.push('FACEBOOK_PAGE_ACCESS_TOKEN', 'FACEBOOK_PAGE_ID');
    if (platforms.includes('facebook_groups'))
        requiredSecrets.push('FACEBOOK_GROUPS_ACCESS_TOKEN');
    if (platforms.includes('tiktok'))
        requiredSecrets.push('TIKTOK_ACCESS_TOKEN', 'TIKTOK_OPEN_ID');
    const results = [];
